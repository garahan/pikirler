      ...
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          ...
          <div className="mb-3 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 via-sky-400 to-purple-500 shadow-glowSoft">
          ...
          <p className="mt-1 text-sm text-muted">
            Pikirleriň dünýäsine hoş geldiň.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-edge bg-card p-6">
          <div className="mb-5 grid grid-cols-2 rounded-full bg-midnight p-1 text-sm font-medium">
            {(['login', 'register'] as Mode[]).map((m) => (
              <button
                ...
                className={`press rounded-full py-2 transition-colors ${
                  mode === m
                    ? 'bg-grad-primary text-midnight'
                    : 'text-muted'
                }`}
              >
          ...
          <div className="space-y-3">
            ...
            {error && (
              <p className="rounded-xl border border-pink/30 bg-pink/10 px-3 py-2 text-sm text-pink">
                {error}
              </p>
            )}
